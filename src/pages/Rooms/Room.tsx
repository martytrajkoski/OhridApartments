...
import { faBed, faCheck, faLocationDot, faParking, faStar, faEnvelope, faPhone } from "@fortawesome/free-solid-svg-icons";
            ...
            <div className="room">
                ...
                <div className="room-display">
                    <div className="room-display-gallery">
                        <Gallery images={roomData?.images ?? []} alternative={`${roomData?.apartment.name} Ohrid Apartments`}/>
                    </div>
                    ...
                    <div className="room-description-container">
                        ...
                        <div className="facilities">
                            ...
                            <div className="contact">
                                <b>Contact: </b>
                                {roomData?.apartment.email && <div><FontAwesomeIcon icon={faEnvelope}/> : {roomData?.apartment.email}</div>}
                                {roomData?.apartment.phone_number && <div className="contact-number"><FontAwesomeIcon icon={faPhone}/> / <svg className="svg-social" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 48 48">
                                ...
                                </svg> : {roomData?.apartment.phone_number.map((number, index) => (<span key={index}>{number} </span>))} </div>}
                            </div>
                        </div>
                    </div>
